...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.highlight'
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, null=True, to=orm['albums.AlbumConvertableItem']))
        db.alter_column('albums_album', 'highlight_id', orm['albums.album:highlight'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Album.highlight'
        # (to signature: django.db.models.fields.related.ForeignKey(null=True, to=orm['albums.AlbumItem'], blank=True))
        db.alter_column('albums_album', 'highlight_id', orm['albums.album:highlight'])
