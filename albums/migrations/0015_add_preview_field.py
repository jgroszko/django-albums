...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumConvertableItem.preview'
        db.add_column('albums_albumconvertableitem', 'preview', orm['albums.albumconvertableitem:preview'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlbumConvertableItem.preview'
        db.delete_column('albums_albumconvertableitem', 'preview')
