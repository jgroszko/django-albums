...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.delete_column("albums_albumitem", "parent_id");

        db.rename_column("albums_albumconvertableitem", "album_id", "parent_id")
    
    
    def backwards(self, orm):
        "Write your backwards migration here"
    
        db.add_column("albums_albumitem", "parent", models.ForeignKey(orm['albums.Album'], null=True))

        db.rename_column("albums_albumconvertableitem", "parent_id", "album_id")
    ...
    models = {
        ...
        'albums.albumconvertableitem': {
            ...
            'parent': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'children'", 'null': 'False', 'to': "orm['albums.Album']"}),
