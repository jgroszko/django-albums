...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.rename_column('albums_album', 'album_slug', 'slug')
        db.rename_column('albums_albumconvertableitem', 'item_slug', 'slug')
    
    
    def backwards(self, orm):
        
        db.rename_column('albums_album', 'slug', 'album_slug')
        db.rename_column('albums_albumconvertableitem', 'slug', 'item_slug')
