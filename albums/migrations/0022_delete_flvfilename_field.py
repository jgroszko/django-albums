...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.flvFilename'
        db.delete_column('albums_video', 'flvFilename')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'Video.flvFilename'
        db.add_column('albums_video', 'flvFilename', orm['albums.video:flvFilename'])
