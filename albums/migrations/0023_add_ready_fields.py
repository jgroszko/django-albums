...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.video_ready'
        db.add_column('albums_video', 'video_ready', orm['albums.video:video_ready'])
        
        # Adding field 'AlbumConvertableItem.preview_ready'
        db.add_column('albums_albumconvertableitem', 'preview_ready', orm['albums.albumconvertableitem:preview_ready'])
        
        db.execute("UPDATE albums_video SET video_ready=True");
        db.execute("UPDATE albums_albumconvertableitem SET preview_ready=True");
    
    def backwards(self, orm):
        
        # Deleting field 'Video.video_ready'
        db.delete_column('albums_video', 'video_ready')
        
        # Deleting field 'AlbumConvertableItem.preview_ready'
        db.delete_column('albums_albumconvertableitem', 'preview_ready')
    ...
    models = {
        ...
        'albums.albumconvertableitem': {
            ...
            'preview_ready': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
        ...
        'albums.video': {
            ...
            'video_ready': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'})
        },
