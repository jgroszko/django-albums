...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumConvertableItem.rating_score'
        db.add_column('albums_albumconvertableitem', 'rating_score', orm['albums.albumconvertableitem:rating_score'])
        
        # Adding field 'AlbumConvertableItem.rating_votes'
        db.add_column('albums_albumconvertableitem', 'rating_votes', orm['albums.albumconvertableitem:rating_votes'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlbumConvertableItem.rating_score'
        db.delete_column('albums_albumconvertableitem', 'rating_score')
        
        # Deleting field 'AlbumConvertableItem.rating_votes'
        db.delete_column('albums_albumconvertableitem', 'rating_votes')
