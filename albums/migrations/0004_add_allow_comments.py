...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumConvertableItem.allow_comments'
        db.add_column('albums_albumconvertableitem', 'allow_comments', orm['albums.albumconvertableitem:allow_comments'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlbumConvertableItem.allow_comments'
        db.delete_column('albums_albumconvertableitem', 'allow_comments')
