...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumConvertableItem.tags'
        tags = orm['albums.albumconvertableitem:tags']
        tags.default = ''
        db.add_column('albums_albumconvertableitem', 'tags', tags)
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlbumConvertableItem.tags'
        db.delete_column('albums_albumconvertableitem', 'tags')
    ...
    models = {
        ...
        'albums.albumconvertableitem': {
            ...
            'favorites': ('django.contrib.contenttypes.generic.GenericRelation', [], {'to': "orm['favorites.Favorite']"}),
            ...
            'preview_ready': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
        ...
        'albums.video': {
            ...
            'video_ready': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'})
        },
        ...
        'favorites.favorite': {
            'Meta': {'unique_together': "(('from_user', 'content_type', 'object_id'),)"},
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['contenttypes.ContentType']"}),
