...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.album_slug'
        # (to signature: django.db.models.fields.SlugField(unique=True, max_length=50, db_index=True))
        db.alter_column('albums_album', 'album_slug', orm['albums.album:album_slug'])
        
        # Changing field 'AlbumConvertableItem.item_slug'
        # (to signature: django.db.models.fields.SlugField(max_length=50, db_index=True))
        db.alter_column('albums_albumconvertableitem', 'item_slug', orm['albums.albumconvertableitem:item_slug'])
        
        # Creating unique_together for [item_slug, parent] on AlbumConvertableItem.
        db.create_unique('albums_albumconvertableitem', ['item_slug', 'parent_id'])
        
        # Creating unique_together for [album_slug] on Album.
        db.create_unique('albums_album', ['album_slug'])
        
    
    
    def backwards(self, orm):
        
        # Deleting unique_together for [album_slug] on Album.
        db.delete_unique('albums_album', ['album_slug'])
        
        # Deleting unique_together for [item_slug, parent] on AlbumConvertableItem.
        db.delete_unique('albums_albumconvertableitem', ['item_slug', 'parent_id'])
        
        # Changing field 'Album.album_slug'
        # (to signature: django.db.models.fields.SlugField(max_length=50, null=True))
        db.alter_column('albums_album', 'album_slug', orm['albums.album:album_slug'])
