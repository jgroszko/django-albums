...
class Migration:
    ...
    def forwards(self, orm):
        ...
        albums_photos_dir = os.path.join(settings.MEDIA_ROOT, 'albums_photos')
        if(os.path.exists(albums_photos_dir)):
            shutil.rmtree(albums_photos_dir)
    
    
    def backwards(self, orm):
        "Write your backwards migration here"
    
        os.makedirs(os.path.join(settings.MEDIA_ROOT, 'avatars'))
        
        os.makedirs(os.path.join(settings.MEDIA_ROOT, 'albums_photos'))
