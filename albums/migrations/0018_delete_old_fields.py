...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AlbumConvertableItem.converted'
        db.delete_column('albums_albumconvertableitem', 'converted')
        
        # Deleting field 'AlbumConvertableItem.thumbFilename'
        db.delete_column('albums_albumconvertableitem', 'thumbFilename')
        
        # Deleting field 'Image.image'
        db.delete_column('albums_image', 'image')
        
        # Deleting field 'Image.imageFilename'
        db.delete_column('albums_image', 'imageFilename')
        
    
    
    def backwards(self, orm):
        
        # Adding field 'AlbumConvertableItem.converted'
        db.add_column('albums_albumconvertableitem', 'converted', orm['albums.albumconvertableitem:converted'])
        
        # Adding field 'AlbumConvertableItem.thumbFilename'
        db.add_column('albums_albumconvertableitem', 'thumbFilename', orm['albums.albumconvertableitem:thumbFilename'])
        
        # Adding field 'Image.image'
        db.add_column('albums_image', 'image', orm['albums.image:image'])
        
        # Adding field 'Image.imageFilename'
        db.add_column('albums_image', 'imageFilename', orm['albums.image:imageFilename'])
