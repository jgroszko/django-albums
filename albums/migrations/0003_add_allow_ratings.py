...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumConvertableItem.allow_ratings'
        db.add_column('albums_albumconvertableitem', 'allow_ratings', orm['albums.albumconvertableitem:allow_ratings'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'AlbumConvertableItem.allow_ratings'
        db.delete_column('albums_albumconvertableitem', 'allow_ratings')
