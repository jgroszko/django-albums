...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Album.is_profile'
        db.add_column('albums_album', 'is_profile', orm['albums.album:is_profile'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Album.is_profile'
        db.delete_column('albums_album', 'is_profile')
